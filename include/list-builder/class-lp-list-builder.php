...
?>
    ...
    public static function handle_signup($request)
    {
        ...
        $subscriber_data = array(
            ...
            'price'    => 0,
            'interval_count' => isset($level['subscription_length_type']) && 'unlimited' === $level['subscription_length_type'] ? 0 : $level['interval_count'],
            'interval'    => isset($level['subscription_length_type']) && 'unlimited' === $level['subscription_length_type'] ? '' : $level['interval'],
            'new_user'    => true,
