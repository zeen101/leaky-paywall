...
?>
		...
		<div class="lp-sections-wrap">

			<?php $this->output_sections_nav($current_tab, $sections, $current_section); ?>
		...
		<div class="wrap">
				...
				<div class="leaky-paywall-sidebar" style="float: right; width: 23%; margin-top: 65px;">
		...
		?>
			...
			<table id="leaky_paywall_default_restriction_options" class="form-table">
				...
				<tr class="restriction-options combined-restrictions-total-allowed <?php echo 'on' !== $settings['enable_combined_restrictions'] ? 'hide-setting' : ''; ?>">
					...
					<td>
						<input type="number" min="0" id="combined_restrictions_total_allowed" class="small-text" name="combined_restrictions_total_allowed" value="<?php echo esc_attr($settings['combined_restrictions_total_allowed']); ?>" />
				...
				<tr class="restriction-options-lead-in-elements <?php echo 'on' !== $settings['enable_js_cookie_restrictions'] ? 'hide-setting' : ''; ?>">
					...
					<td>
						<input type="number" id="lead_in_elements" class="small-text" name="lead_in_elements" min="0" value="<?php echo esc_attr($settings['lead_in_elements']); ?>">
						<p class="description">
