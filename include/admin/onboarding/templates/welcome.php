<div id="leaky-paywall-onboarding--welcome" class="leaky-paywall-onboarding--step">
	<form method="post" action="<?php echo esc_url(admin_url('admin.php?page=leaky-paywall-setup&step=welcome')); ?>">
		...
		<p class="leaky-paywall-onboarding--tagline"><?php esc_html_e('You are just minutes away from launching your paywall on WordPress!', 'leaky-paywall'); ?></p>
		...
		<ul id="leaky-paywall-onboarding--publication-types">
			...
			<li><label><input type="checkbox" name="publication_types[]" value="news" /><?php esc_html_e('B2B News', 'leaky-paywall'); ?></label></li>
			...
			<li><label><input type="checkbox" name="publication_types[]" value="niche" /><?php esc_html_e('Niche Content Creator', 'leaky-paywall'); ?></label></li>
