...
if ( !function_exists( 'leaky_paywall_general_metaboxes' ) ) {
	...
	function leaky_paywall_general_metaboxes() {
		...
		$hidden_post_types = apply_filters( 'leaky_paywall_hidden_post_types_metaboxes', array( 'attachment', 'revision', 'nav_menu_item', 'lp_transaction', 'lp-coupons', 'ad_dropper' ) );
