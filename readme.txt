...
* Learn more at [leakypaywall.com](https://leakypaywall.com/)
* Documentation: [docs.leakypaywall.com](https://docs.leakypaywall.com/)
* Publisher resources: [publisherrevenue.com](https://publisherrevenue.com/)
* Paywall Podcast: [leakypaywall.com/paywall-podcast](https://leakypaywall.com/paywall-podcast/)
* YouTube: [youtube.com/@leakypaywall](https://www.youtube.com/@leakypaywall)
...
5. Leaky Paywall visibility settings let you override the default restrictions on a per-content basis
6. Leaky Paywall subscriber table to manage current subscribers and manually add new subscribers
7. Leaky Paywall subscribe prompt after a reader has reached their article limit
8. Leaky Paywall subscribe cards
9. Leaky Paywall registration form for both free and paid levels
...
* Add self verification for deprecated paypal IPN
