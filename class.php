			...
			<div class=wrap>
				<div style="width:70%;" class="postbox-container">
					...
					<form id="leaky-paywall" method="post" action="">
						...
						<?php if ( 'emails' == $current_tab ) : // email tab settings 
						?>
						...
						<?php if ( 'payments' == $current_tab ) : // payments settings tab 
						?>
								...
								<tr class="gateway-options">
									...
									<td>
										...
										foreach ( $gateways as $key => $value ) {
											...
											if ( 'stripe' == $key && in_array( 'stripe_checkout', $settings['payment_gateway'] ) && ! in_array( 'stripe', $settings['payment_gateway'] ) ) {
						...
						<?php if ( 'subscriptions' == $current_tab ) : // subscriptions settings tab 
						?>
