...
if ( ! class_exists( 'zeen101_Leaky_Paywall' ) ) {
	...
	class zeen101_Leaky_Paywall {
		...
		/**
		 * Enqueues backend zeen101 styles
		 *
		 * @since 1.0.0
		 */
		...
		/**
		 * Create and Display zeen101 settings page
		 *
		 * @since 1.0.0
		 */
		...
		function subscribers_page() {
			...
			<div class="wrap">
				...
				$subscriber_table = new zeen101_Leaky_Paywall_Subscriber_List_Table();
		...
		/**
         * API Request sent and processed by the zeen101 API
         *
         * @since 1.0.0
         *
         * @param array $args Arguments to send to the zeen101 API
         */
