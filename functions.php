...
if ( ! function_exists( 'send_leaky_paywall_email' ) ) {
	...
	function send_leaky_paywall_email( $email )
	{
		...
		$message .= __( 'This link will expire after an hour and can only be used once. To log into multiple browsers, send a login request from each one.', 'leaky-paywall' ) . "\r\n";
...
if ( ! function_exists( 'build_leaky_paywall_subscription_levels_row' ) ) {
			...
			switch ( $status ) {
				...
				case 'update':
					...
					if ( 'off' === $settings['new_subscriber_admin_email'] ) {
						...
						$admin_raw_message = '<p>' . __( 'A new user has signed up on', 'leaky-paywall' ) . ' ' . $site_name . '.</p>
											  <h3>' . __( 'Subscriber details', 'leaky-paywall' ) . '</h3>
											  <ul>
	...
	?>
		...
		<h3><?php _e( 'Leaky Paywall', 'leaky-paywall' ); ?></h3>

		<table class="form-table">

			<tr>
				<th><label for="level_id"><?php _e( 'Level ID', 'leaky-paywall' ); ?></label></th>
			...
			<tr>
				<th><label for="level_description"><?php _e( 'Level Description', 'leaky-paywall' ); ?></label></th>
			...
			<tr>
				<th><label for="payment_gateway"><?php _e( 'Payment Gateway', 'leaky-paywall' ); ?></label></th>
			...
			<tr>
				<th><label for="payment_status"><?php _e( 'Payment Status', 'leaky-paywall' ); ?></label></th>
			...
			<tr>
				<th><label for="expires"><?php _e( 'Expires', 'leaky-paywall' ); ?></label></th>
			...
			?>
				<tr>
					<th><label for="plan"><?php _e( 'Plan', 'leaky-paywall' ); ?></label></th>
			...
			?>
				<tr>
					<th><label for="subscriber_id"><?php _e( 'Subscriber ID', 'leaky-paywall' ); ?></label></th>
			...
			?>
				<tr>
					<th><label for="subscriber_notes"><?php _e( 'Subscriber Notes', 'leaky-paywall' ); ?></label></th>
	...
	{
		$settings_link  = '<a target="_blank" href="https://zeen101.com/pubcare/">' . __( 'Premium Support', 'leaky-paywall' ) . '</a>  | ';
		$settings_link .= '<a href="admin.php?page=issuem-leaky-paywall">' . __( 'Settings', 'leaky-paywall' ) . '</a>';
	...
	function leaky_paywall_add_toolbar_items( $admin_bar )
	{
		...
		$admin_bar->add_menu(array(
			...
			'title' => __( 'Leaky Paywall', 'leaky-paywall' ),
		...
		$admin_bar->add_menu( array(
			...
			'href'   => admin_url() . 'admin.php?page=issuem-leaky-paywall',
			'meta'   => array(
				'title'  => __( 'Settings', 'leaky-paywall' ),
				'target' => '',
		...
		$admin_bar->add_menu(array(
			...
			'meta'   => array(
				'title'  => __( 'Subscribers', 'leaky-paywall' ),
				'target' => '',
				'class'  => 'my_menu_item_class'
			),
		));
		...
		$admin_bar->add_menu(array(
			...
			'meta'   => array(
				'title'  => __( 'Transactions', 'leaky-paywall' ),
				'target' => '',
				'class'  => 'my_menu_item_class'
			),
		) );
		...
		$admin_bar->add_menu( array(
			...
			'meta'   => array(
				'title'  => __( 'Add-Ons', 'leaky-paywall' ),
				'target' => '',
				'class'  => 'my_menu_item_class'
			),
		) );
