...
function do_leaky_paywall_register_form( $atts ) {
	...
	<div class="leaky-paywall-subscription-details-wrapper">
		...
		<ul class="leaky-paywall-subscription-details">
			<li class="leaky-paywall-subscription-details-subscription-name"><strong><?php printf( esc_attr__( 'Your Order:', 'leaky-paywall' ) ); ?></strong> <?php echo esc_attr( apply_filters( 'leaky_paywall_registration_level_name', $level['label'] ) ); ?></li>
